...
- **커밋 상태:** 이 항목 작성 시 실행 직전. 메시지는 `docs(coding-agent): record Weavra V0.4C sandbox closure`이며 실제 SHA·최종 HEAD CI는 최종 응답에서 보고한다.
